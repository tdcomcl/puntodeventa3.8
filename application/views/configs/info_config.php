...
<div id="config_wrapper">
	<fieldset id="config_info">
				...
				<div class="fileinput <?php echo $logo_exists ? 'fileinput-exists' : 'fileinput-new'; ?>" data-provides="fileinput">
					...
					<div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 200px;">
						<img data-src="holder.js/100%x100%" alt="<?php echo $this->lang->line('config_company_logo'); ?>" src="<?php if ($logo_exists) echo base_url('uploads/' . $this->config->item('company_logo'));
																																else echo ''; ?>" style="max-height: 100%; max-width: 100%;">
					</div>
					<div>
		...
		<div class="form-group form-group-sm">
			<?php echo form_label('Hash de Servidor', 'Hash de servidor', array('class' => 'control-label col-xs-2')); ?>
			<div class="col-xs-6">
				<div class="input-group">
					<span class="input-group-addon input-sm"><span class="glyphicon glyphicon-cog"></span></span>
					<?php echo form_input(array(
						'name' => 'hash',
						'id' => 'hash',
						'class' => 'form-control input-sm',
						'value' => $this->config->item('hash')
					)); ?>
				</div>
			</div>
		</div>
		...
		<div class="form-group form-group-sm">
			<?php echo form_label('RUT Empresa', 'Hash de servidor', array('class' => 'control-label col-xs-2')); ?>
			<div class="col-xs-6">
				<div class="input-group">
					<span class="input-group-addon input-sm"><span class="glyphicon glyphicon-cog"></span></span>
					<?php echo form_input(array(
		...
		<div class="form-group form-group-sm">
			<?php echo form_label($this->lang->line('url_dte'), 'URL Servidor DTE', array('class' => 'control-label col-xs-2')); ?>
			<div class="col-xs-6">
				<div class="input-group">
					<span class="input-group-addon input-sm"><span class="glyphicon glyphicon-cog"></span></span>
					<?php echo form_input(array(
						...
						'id' => 'url_dte',
						'class' => 'form-control input-sm',
						'value' => $this->config->item('url_dte')
					)); ?>
				</div>
			</div>
		</div>
		...
		<div class="form-group form-group-sm">
			<?php echo form_label('Regla de emision documento', 'Regla de emision documento', array('class' => 'control-label col-xs-2')); ?>
			<div class="col-xs-6">
	
					<?php

					$options = [
						'1'  => 'Siempre emitir boleta',
						'2'    => 'No emitir boleta',
						'3'  => 'Preguntar',
		...
		<div class="form-group form-group-sm">
			<?php echo form_label('Tipo de Boleta', 'tipo Boleta', array('class' => 'control-label col-xs-2')); ?>
			<div class="col-xs-6">
					...
					echo form_dropdown('tipob', $options, [
						'name' => 'tipob',
						'id' => 'tipob',
						'class' => 'form-control input-sm',
						'value' => $this->config->item('tipob')
					]);
