      ...
      <?php else: ?>
        <svg class="logo text-primary" role="img" viewBox="0 0 308.57998 308.57997" xmlns="http://www.w3.org/2000/svg">
         <title> <?php echo $this->lang->line('common_software_title') . '&nbsp;' . $this->lang->line('common_logo'); ?> </title>
          ...
          <path fill="#fff" d="M260.0 35.8137l-32.2672-33.8137c-2.5-2.5-4.3-2.9-7.2 0l-99.3 99.1q-4.8 4.8-8.5 1.1c-47.8-43.5-23.8-45.2-71.3-.6-4.2 4.1-3 6 0 9 17.5 17.2 52.4 52 69.7 69.2 4.9 4.8 6.2 5 11 .1l138-137.4c3.4-3.4 3.5-4.7.3-7.9m1.5 29.7c0-2-2-4.2-4.5-1.8-1.6 1.6-39.3 39.1-45.7 45.5-6 6-5.8 5-5.8 16.2l0 122.3c0 3.1 2.9 3.1 4 1.2 1.4-1.5 4.2-13.5 7.8-9.2l5.8 9.5c5.2 5.3 6.7-14.8 11.9-9.5l5.4 9.6c5.1 5.3 7-14.9 12.1-9.6l5.2 9.3c1.1 1.8 3.8 1.2 3.8-.8l0-182.8m-222.9 68.9c0-2 2-4.2 4.5-1.8 1.6 1.6 39.3 39.1 45.7 45.5 5.9 5.8 5.8 3.4 5.8 16.2l0 53.2c0 3.1-2.9 3.1-4 1.2l-4.4-9.2c-.8-1.2-2.6-1.2-3.4 0l-5.8 9.5c-.8 1.2-2.6 1.2-3.4 0l-5.2-9.5c-5.1-5.3-7 14.8-12.2 9.6l-5.4-9.6c-.8-1.2-2.6-1.2-3.4 0l-5.2 9.3c-1.1 1.8-3.8 1.2-3.8-.8l0-113.7"/>
        </svg>
      <?php endif; ?>
      </div>
